                ...
                <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="addBalance" method="post" class="form-horizontal" enctype="multipart/form-data">
                          {{ csrf_field() }} 
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="hf-password" name="balance" placeholder="Enter Balance..." class="form-control item" required>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Paid Balance</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="hf-password" name="paidBalance" placeholder="Enter Paid Balance..." class="form-control item" required></div>
                          </div>
